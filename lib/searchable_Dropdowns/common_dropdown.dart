...
class CommonDropdown extends StatefulWidget{
  ...
  final nameField;
  final idField;
  CommonDropdown({required this.title, required this.callback, required this.ledgerName,this.titleIndicator,required this.apiUrl, this.franchisee, this.franchiseeName, this.come,this.suffixicon, this.readOnly,this.focuscontroller,this.txtkey,this.focusnext,this.mandatory, this.nameField, this.idField, this.borderColor});
  @override
  State<CommonDropdown> createState() => _SingleLineEditableTextFormFieldState();
}

class _SingleLineEditableTextFormFieldState extends State<CommonDropdown> with  SingleTickerProviderStateMixin {
            ...
            Padding(
              ...
              child:  Container(
                ...
                decoration: BoxDecoration(
                  color:widget.borderColor==true? Colors.red:CommonColor.WHITE_COLOR,
                ...
                child:    TypeAheadFormField(
                  ...
                  textFieldConfiguration: TextFieldConfiguration(
                    ...
                    style:/*widget.readOnly==false?item_heading_textStyle.copyWith(color: Colors.black): */item_heading_textStyle,
                    onChanged: (v)async{
                      if(v.isEmpty) {
                        setState(() {
                          selectedItem=null;
  ...
  Future<List> fetchSimpleData(searchstring) async {
    ...
    results = filteredStates
        .where((user) =>
        user["${widget.nameField.toString()}"]
            .toLowerCase()
  ...
  List _getSuggestions(String query) {
    ...
    matches.retainWhere((s) => s['${widget.nameField.toString()}'].toLowerCase().contains(query.toLowerCase()));
    return matches;
  }
